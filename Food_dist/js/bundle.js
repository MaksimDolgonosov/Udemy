...
function calc() {
  ...
  getDinamicInformaton("#age"); // document.querySelectorAll(".calculating__choose_medium input").forEach(e => {
...
function cards() {
  ...
  var Cards = /*#__PURE__*/function () {
    function Cards(img, alt, name, text, price, parentSelector) {
...
function forms(formSelector, setTimeoutId) {
  ...
  function bindPostData(form) {
    form.addEventListener('submit', function (e) {
      ...
      var json = JSON.stringify(Object.fromEntries(formData.entries())); // let Object = {};
  ...
  function showThanksModal(message) {
    var prevModalDialog = document.querySelector(".modal__content");
    prevModalDialog.classList.add("hide");
    (0,_modal__WEBPACK_IMPORTED_MODULE_8__.openModal)(".modal", setTimeoutId);
...
function modal(triggerSelector, modalSelector, setTimeoutId) {
  ...
  var modal = document.querySelector(modalSelector); //const styleOfModal=window.getComputedStyle(modal);
  //console.log(styleOfModal);

  var modalTrigger = document.querySelectorAll(triggerSelector); // const btnClose = document.querySelector("[data-close]");

  modalTrigger.forEach(function (btn) {
    btn.addEventListener("click", function () {
      return openModal(modalSelector, setTimeoutId);
    });
  }); //btnClose.addEventListener("click", closeModal);

  modal.addEventListener("click", function (e) {
    if (e.target === modal || e.target.classList.contains("modal__close")) {
      //e.target.getAttribute(`modal-close`)=="";
...
function slides(_ref) {
  ...
  nextBtn.addEventListener("click", function () {
    ...
    if (slideIndex < 10) {
      document.querySelector("#current").textContent = "0".concat(slideIndex);
    } else {
...
function timer(id, deadline) {
  ...
  function setClock(selector, endtime) {
    ...
    var SetInterval = setInterval(updateClock, 1000);
    updateClock();

    function updateClock() {
      var t = getTimeRemanig(endtime);
...
window.addEventListener("DOMContentLoaded", function () {
  var setTimeoutId = setTimeout(function () {
    return (0,_modules_modal__WEBPACK_IMPORTED_MODULE_5__.openModal)(".modal", 3);
  }, 5000); //const setTimeoutId2 = setTimeout(() => openModal(".modal", setTimeoutId2), 5000);

  (0,_modules_tabs__WEBPACK_IMPORTED_MODULE_1__["default"])();
  (0,_modules_cards__WEBPACK_IMPORTED_MODULE_2__["default"])();
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_4__["default"])(".timer", '2021-12-14');
  (0,_modules_modal__WEBPACK_IMPORTED_MODULE_5__["default"])("[data-modal]", ".modal", setTimeoutId);
  (0,_modules_calc__WEBPACK_IMPORTED_MODULE_6__["default"])();
  (0,_modules_forms__WEBPACK_IMPORTED_MODULE_7__["default"])('form', setTimeoutId);
